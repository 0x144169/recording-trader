...
- ☯ **小助手六爻起卦**：右键新增「六爻起卦（开仓意念）」入口，静心倒计时后给出结果。
- 📜 **本真 + 易懂双层结论**：保留本卦/变卦/动爻与主断，同时给出大白话建议。
- ✂️ **播报更短**：结果收敛为短句，保留「仅供娱乐辅助，交易风险自担」提示。
- 🧩 **设置区更顺手**：虚拟助手与语音 AI 同行展示，并新增六爻使用 Tips。

## 教学视频

官方教学按真实使用顺序持续补齐：先把下载、安装、更新跑顺，再进入工作区、盘前计划、第一笔订单、Journal 总览与复盘模式。
...
- **适合现在观看**：第一次下载、第一次进入主界面、准备开始正式记录与复盘交易
- **备用直链**
