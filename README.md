...
- 🙂 **订单可记录下单情绪**：新建订单新增情绪状态，支持用更直观的人话记录当时感受，例如“市场在和我作对”“有点上头”。
- 🧭 **情绪与复盘归因区分更清楚**：界面已明确区分“下单情绪”和“心理短板/弱点”，避免把当下状态和事后归因混为一谈。
- 🤖 **AI 与搜索同步纳入情绪**：单笔 AI 分析、知识库对话摘要，以及复盘/学习园搜索现在都会带上情绪字段，后续复盘更顺手。
